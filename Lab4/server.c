...
void writeDataToFile(char* data);	//write the data transfered into a file
...
/**
* This function prints the message to console and logs it to the file "server.txt"
*
*/
void logMessage(char* message) {
...
/**
* This function logs the tcp header to the file "server.txt"
*
*/
void logHeader(struct tcp_hdr tcp_seg) {
